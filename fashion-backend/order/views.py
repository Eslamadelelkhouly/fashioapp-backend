...
from extra.models import Address
    ...
    def post(self ,request):
        ...
        try:
            with transaction.atomic():
                validate_products = []
                for product_data in data['order_product']:
                    ...
                    order = models.Order.objects.create(
                        ...
                        address = address,
                        order_product = validate_products,
                        rated = [0],
            ...
            return Response({"message":"user addres does not exist"}, status=status.HTTP_404_NOT_FOUND)
